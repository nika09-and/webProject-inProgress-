...
function createNewElement(info) {
  ...
  newParent.id = "largProduct";
  document.getElementById("mainProducts").appendChild(newParent);

  const newPhotoParent = document.createElement("div");
  newPhotoParent.id = "largPhoto";
  newParent.appendChild(newPhotoParent);

  const newPhoto = document.createElement("img");
  newPhoto.id = "largProductPhoto";
  newPhotoParent.appendChild(newPhoto);

  const newInfoParent = document.createElement("div");
  newParent.id = "largProductInfo";
  newParent.appendChild(newInfoParent);

  // Add product details
  const largTitle = document.createElement("p");
  largTitle.id = "largTitle";
  newInfoParent.appendChild(largTitle)

  const largPrice = document.createElement("p");
  largPrice.id = "largPrice";
  newInfoParent.appendChild(largPrice)
}
